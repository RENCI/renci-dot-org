...
const componentMap = {
  ...
  p: ({ children }) => (
    <Typography paragraph sx={{ "&:last-of-type": { mb: 0 } }}>
      {children}
    </Typography>
  ),
...
const markdownlessMap = {
  a: ({ node, children }) => <Fragment>{children}</Fragment>,
  p: ({ node, children }) => <Fragment>{children}</Fragment>,
  h1: ({ node, children }) => <Fragment>{children}</Fragment>,
  h2: ({ node, children }) => <Fragment>{children}</Fragment>,
  h3: ({ node, children }) => <Fragment>{children}</Fragment>,
  ul: ({ node, children }) => <Fragment>{children}</Fragment>,
  li: ({ node, children }) => <Fragment>{children}</Fragment>,
};

export const MarkdownLess = ({ children }) => {
  return <ReactMarkdown components={markdownlessMap}>{children}</ReactMarkdown>;
};
