        ...
        <Grid container>
          ...
          <Grid item xs={12} md={4} lg={2} className="link-group">
            ...
            <ul className="link-list">
              <li>
                <Link to="https://www.unc.edu/">UNC-Chapel Hill</Link>
              </li>
              <li>
                <Link to="https://www.ncsu.edu/">NC State University</Link>
              </li>
              <li>
          ...
          <Grid item xs={12} md={4} lg={2} className="link-group">
            ...
            <ul className="link-list">
              <li>
                <Link to="https://www.twitter.com/RENCI">Twitter</Link>
              </li>
              <li>
                <Link to="https://www.facebook.com/renci.org">Facebook</Link>
              </li>
              <li>
                <Link to="https://www.linkedin.com/company/65321">
                  LinkedIn
                </Link>
              </li>
              <li>
                <Link to="https://www.youtube.com/RENCIMedia">YouTube</Link>
              </li>
            </ul>
          </Grid>
          <Grid item xs={12} md={4} lg={2} className="link-group">
