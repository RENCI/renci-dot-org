...
export default function ResearchGroups({ collaborations }) {
  return (
    <Page title="Collaborations" description="RENCI's collaborations...">
      <Typography paragraph>
        ...
        outreach and engagement expertise has landed us funding on multiple new
        federal projects. Though we have well-established and recognized
      ...
      <Typography paragraph>
        ...
        that exist explicitly to bring people together around important data
        science initiatives.
      </Typography>
